...
func (t *H2R) DialMux(ctx context.Context, dm *ugate.Cluster, meta http.Header, ev func(t string, stream *nio.Stream)) (ugate.Muxer, error) {
	...
	str = nio.NewStreamRequestOut(postR, w, res, nil)
...
func (t *H2R) HandleH2R(w http.ResponseWriter, r *http.Request) {
	...
	str.TLS = r.TLS // TODO: also get the WorkloadID from JWT
	...
	k := ugatesvc.RemoteID(str) // mesh WorkloadID based on client cert.
