...
func (a *ADSC) handleRecv() {
	for {
		...
		msg := mm.(*discovery.DiscoveryResponse)
		log.Printf("got message for type %v", msg.TypeUrl)
...
func (a *ADSC) makeNode() *core.Node {
	...
	if a.Config.Locality != "" {
		n.Locality = &core.Locality{Zone: a.Config.Locality}
	}
